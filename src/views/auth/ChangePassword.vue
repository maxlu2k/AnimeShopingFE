                    ...
                    <v-card-text>
                        <v-form @submit.prevent ref="form">
                            <v-row>
                                ...
                                <v-col cols="12">
                                    <v-text-field v-model="item.oldPassword" label="Mật khẩu cũ" id="old_password__login"
                                ...
                                <v-col cols="12">
                                    <v-text-field v-model="item.confirmPassword" label="Mật khẩu xác nhận"
...
const submitForm = async () => {
    ...
    changePassword(item.value).then((resp) => {
