<template>
  <VCard class="ma-5" elevation="12">
    <VRow class="ma-1 mb-0">
      <h2 class="v-col-12 text-center">Property</h2>
    ...
    <v-card>
      ...
      <v-card-text>
        <v-container>
          <v-row>
            <v-col cols="12">
              <v-text-field v-model="currentItem.name" label="Property name"></v-text-field>
            </v-col>
          </v-row>
        </v-container>
      </v-card-text>
