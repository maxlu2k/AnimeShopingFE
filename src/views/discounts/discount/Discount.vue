                        ...
                        <v-card-text>
                            <v-container>
                                <v-form @submit.prevent ref="form" class="form_cua_thang">
                                    <v-row>
                                        <v-col cols="12">
                                            <v-text-field v-model="item.name" label="Tên giảm giá" :rules="nameValidate"
                                                variant="outlined"></v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12" md="6">
                                            <VueDatePicker v-model="item.discountStart" placeholder="Bắt đầu"
                                                :class="{ 'date_start_': cssDate.start }" @update:model-value="changeStart()">
                                            </VueDatePicker>
...
<script setup>
import { ref } from 'vue';
import { getAll, save, update } from '@/services/discount/discountService';
