    ...
    <v-container fluid>
            ...
            <v-card-text>
                <v-row>
                    <v-col cols="12" md="6" sm="12">
                        <v-text-field :model-value="discount.name" readonly label="Tên giảm giá"
                ...
                <v-row>
                    <v-col cols="12" md="6" sm="12">
                        <v-text-field :model-value="formatDate(discount.discountStart)" readonly label="Bắt đầu"
                            variant="outlined"></v-text-field>
                    </v-col>
                    <v-col cols="12" md="6" sm="12">
                        <v-text-field :model-value="formatDate(discount.discountEnd)" readonly label="Kết thúc"
                            variant="outlined"></v-text-field>
                    </v-col>
                </v-row>
                <v-row>
                    <v-col cols="12" md="6" sm="12">
                        <v-text-field :model-value="discount.status ? 'Active' : 'Non-active'" readonly label="Trạng thái"
                            variant="outlined"></v-text-field>
                    </v-col>
                    <!-- <v-col cols="12" md="6" sm="12">
        ...
        <v-card class="ma-5">
            <v-card-title>
                <v-row>
                    <v-col cols="12" md="5">
                        <v-text-field label="Tên sản phẩm" v-model="filter.name" variant="outlined"></v-text-field>
                    </v-col>
                    <v-col cols="12" md="5">
                        <v-select v-model="filter.categories" label="Danh mục" :items="categories" item-title="name"
...
import { getDiscountById,getById,removeAll,saveAll,saveProductDiscount,removeProductDiscount } from '@/services/discount/discountService';
import { getAllCategory } from '@/services/sell/productService';
